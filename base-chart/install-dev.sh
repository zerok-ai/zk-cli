...
helm repo update
helm upgrade zk-scenario-manager zk-scenario-manager/zk-scenario-manager --install --create-namespace --namespace zk-client --version 0.0.1-dev

helm repo add zk-axon https://helm.zerok.ai/zk-client/zk-axon
helm repo update
helm upgrade zk-axon zk-axon/zk-axon --install --create-namespace --namespace zk-client --version 0.0.1-dev